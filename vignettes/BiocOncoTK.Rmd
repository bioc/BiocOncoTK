...
## PanCancer Atlas -- restfulSE is deprecated

3/2024: The code here seems little used.  The
BigQuery interfaces could be restored on request.
...
if (interactive()) {
 ...
 patelSE
 SummarizedExperiment::assay(patelSE[1:4,1:3]) # in memory
}
```
...
if (rhdf5client::check_hsds()) {
 ...
 darmSE
 SummarizedExperiment::assay(darmSE)  # out of memory
}
```
